 ...
 */
define(['angular', 'home', 'duty', 'ui.grid', 'select2'], function (angular) {
    'use strict';

    // We must already declare most dependencies here (except for common), or the submodules' routes
    // will not be resolved
    return angular.module('app', ['ngStorage', 'ui.select', 'ui.grid', 'ui.grid.edit', 'ui.grid.autoResize', 'sc.home', 'sc.duty']);
});
